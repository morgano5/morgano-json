...
public class ObjectDeserializerTest {
	...
	public void collectionsTest() throws JSONReaderException {
		Collection<String> myObject = new HashSet<>();
	...
	public void rootArrayTest() throws JSONReaderException {
		...
		ObjectDeserializer.mergeFromReader(new StringReader("[ 4, 8, 12, 16, 20]"), myIntegerArray);
	...
	public void rootArray2Test() throws JSONReaderException {
		...
		ObjectDeserializer.mergeFromReader(new StringReader("[ \"Hola mundo\", true, 12345, null, \"1973-12-22T03:10:00.000Z\"]"), array);
	...
	public void rootArray3Test() throws JSONReaderException {
		...
		ObjectDeserializer.mergeFromReader(new StringReader("[ 2, 4, 6, 8, 10 ]"), integers);
	...
	public void rootArray4Test() throws JSONReaderException {
		List<Object> moreIntegers = new ArrayList<>();
		ObjectDeserializer.mergeFromReader(new StringReader("[ 3, 6, 9, 12, 15 ]"), moreIntegers);
	...
	public void autoGeneratedMapsTest() throws JSONReaderException {
		Object result = ObjectDeserializer.getFromReader(new StringReader("{\"myString\": \"Hola mundo\", \"myBoolean\": true, \"myInteger\": 12345, \"myNull\": null, \"myDate\": \"1973-12-22T03:10:00.000Z\"}"));
	...
	public void autoGeneratedListsTest() throws JSONReaderException {
		Object result = ObjectDeserializer.getFromReader(new StringReader("[ \"Hola mundo\", true, 12345, null, \"1973-12-22T03:10:00.000Z\"]"));
	...
	public void autoGeneratedMapInMaptest() throws JSONReaderException {
		Object result = ObjectDeserializer.getFromReader(new StringReader("{\"myString\": \"Hola mundo\", \"myBoolean\": true, \"myNull\": null, \"myDate\": \"1973-12-22T03:10:00.000Z\", \"myInternalClass\": {\"myString\": \"inside...\"}, \"myInteger\": 12345}"));
		assertTrue(Map.class.isAssignableFrom(result.getClass()));
		Map map = (Map)result;
	...
	public void nullTest() throws JSONReaderException {
		Object result = ObjectDeserializer.getFromReader(new StringReader("{\"myString\": \"Hola mundo\", \"myBoolean\": true, \"myNull\": null, \"myDate\": \"1973-12-22T03:10:00.000Z\", \"myInternalClass\": {\"myString\": \"inside...\"}, \"myInteger\": 12345}"), null);
		assertTrue(Map.class.isAssignableFrom(result.getClass()));
		Map map = (Map)result;
		assertEquals("inside...", ((Map) map.get("myInternalClass")).get("myString"));
	}
	...
	@Test
	public void getString() throws JSONReaderException {
		String result = ObjectDeserializer.getFromReader(new StringReader("\"Hello world\""), String.class);
		assertEquals("Hello world", result);
	}

	@Test
	public void getNumber() throws JSONReaderException {
		Object result;

		result = ObjectDeserializer.getFromReader(new StringReader("12"), Byte.class);
		assertEquals(Byte.class, result.getClass());
		assertEquals("12", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12"), Short.class);
		assertEquals(Short.class, result.getClass());
		assertEquals("12", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12"), Integer.class);
		assertEquals(Integer.class, result.getClass());
		assertEquals("12", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12"), Long.class);
		assertEquals(Long.class, result.getClass());
		assertEquals("12", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12.34"), Float.class);
		assertEquals(Float.class, result.getClass());
		assertEquals("12.34", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12.34"), Double.class);
		assertEquals(Double.class, result.getClass());
		assertEquals("12.34", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12"), BigInteger.class);
		assertEquals(BigInteger.class, result.getClass());
		assertEquals("12", result.toString());

		result = ObjectDeserializer.getFromReader(new StringReader("12"), BigDecimal.class);
		assertEquals(BigDecimal.class, result.getClass());
		assertEquals("12", result.toString());
	}

	@Test
	public void getBoolean() throws JSONReaderException {
		Boolean result = ObjectDeserializer.getFromReader(new StringReader("true"), Boolean.class);
		assertTrue(result);
	}

	@Test
	public void primitive() throws JSONReaderException {
		Object result;
		result = ObjectDeserializer.getFromReader(new StringReader("true"));
		assertTrue(result.getClass() == Boolean.class);
		result = ObjectDeserializer.getFromReader(new StringReader("12"));
		assertTrue(result.getClass() == BigDecimal.class);
		result = ObjectDeserializer.getFromReader(new StringReader("12.34"));
		assertTrue(result.getClass() == BigDecimal.class);
		result = ObjectDeserializer.getFromReader(new StringReader("\"Hello world\""));
